...
"[project]/src/app/resultado/page.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ResultadosBusqueda() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!query) return;
        fetch(`http://localhost:3001/api/productos?q=${encodeURIComponent(query)}`).then((res)=>{
            if (!res.ok) {
                throw new Error(`HTTP error! status: ${res.status}`);
            }
            return res.json();
        }).then((data)=>setProductos(data)).catch((err)=>console.error('Error al obtener productos:', err));
    }, [
        query
    ]);
...
//# sourceMappingURL=src_app_resultado_page_jsx_2c852a6f._.js.map